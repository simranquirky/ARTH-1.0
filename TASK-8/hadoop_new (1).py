...
print("""
 ...
 Press 15 : To check sevices is started
 Press 16 : Exit
""")
while True:
	...
	if int(ch) == 1:
		...
		y = sp.getstatusoutput("jps")
		if "name node" in y[1][0] or "name" in y[1][0]:
			print("Name node services is started")
		elif "data node" in y[1][0] or "data" in y[1][0]:
			print("data node services is started")
		else:
			print("There is only java service which is running right now!!")
